/**
 * GraphQL Service Snapshot Client - Convenience Functions
 *
 * Convenience functions using the default client singleton.
 * These provide a simpler API for common operations.
 *
 * US-005: Add Correlation ID to GraphQL Service
 */

import type { GraphQLOperationResult } from '../snapshot-client/types'
import { graphqlServiceSnapshotClient } from './client'
import { cleanupExpiredCacheEntries } from '../snapshot-client/cache'
