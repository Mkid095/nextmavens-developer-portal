    ...
    <div className="min-h-screen bg-[#F3F5F7]">
      ...
      <main className="mx-auto max-w-[1180px] px-4 py-12">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-semibold text-slate-900">Versioning & Deprecation</h1>
            <p className="text-slate-600">API versioning policies, SDK releases, and deprecation timeline</p>
          </div>
        </div>
      </main>
    </div>
