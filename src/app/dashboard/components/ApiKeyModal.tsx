...
export function ApiKeyModal({ isOpen, onClose, onCreate, submitting, error }: ApiKeyModalProps) {
  const [formData, setFormData] = useState({
    name: '',
    key_type: 'secret' as ApiKeyType,
    environment: 'live',
    scopes: [] as string[],
  })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    const environment = environmentMap[formData.environment] || 'dev'
    onCreate({
      name: formData.name,
